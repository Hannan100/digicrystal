...
NidoranMFrontpic:    INCBIN "gfx/pokemon/guilmon/front.animated.2bpp.lz"
...
NidoranMBackpic:     INCBIN "gfx/pokemon/guilmon/back.2bpp.lz"
...
INCBIN "gfx/pokemon/demiveemon/back.2bpp.lz"
