...
GoblimonIcon:       INCBIN "gfx/icons/goblimon.2bpp"
BugIcon:          INCBIN "gfx/icons/bug.2bpp"
GhostIcon:        INCBIN "gfx/icons/ghost.2bpp"
SeadramonIcon:       INCBIN "gfx/icons/seadramon.2bpp"
...
GarurumonIcon:     INCBIN "gfx/icons/garurumon.2bpp"
NyokomonIcon:    INCBIN "gfx/icons/nyokomon.2bpp"
GuilmonIcon:   INCBIN "gfx/icons/guilmon.2bpp"
CaterpillarIcon:  INCBIN "gfx/icons/caterpillar.2bpp"
UnownIcon:        INCBIN "gfx/icons/unown.2bpp"
GotsumonIcon:      INCBIN "gfx/icons/gotsumon.2bpp"
...
OtamamonIcon:     INCBIN "gfx/icons/otamamon.2bpp"
