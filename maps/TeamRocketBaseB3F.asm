...
GruntM28Script:
	...
	waitbutton
	closetext
	setevent EVENT_LEARNED_TSUNOMON_TAIL
	end
...
.Script:
	...
	checkevent EVENT_LEARNED_TSUNOMON_TAIL
	iffalse .NeedsPassword
	jump .OpenSesame
...
TeamRocketBaseB3F_MapEvents:
	...
	object_event  5, 14, SPRITE_ROCKET, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TsunomonTailGrunt, EVENT_TEAM_ROCKET_BASE_POPULATION
