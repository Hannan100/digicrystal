...
.MetGrandpa:
	...
	iftrue .ShowedPichu
	checkevent EVENT_SHOWED_RENAMON_VULPIX_TO_BILLS_GRANDPA
	iftrue .ShowedRenamonVulpix
...
.GotWaterStone:
	checkver
	iftrue .AskVulpix
	writetext BillsGrandpaRenamonText
	promptbutton
	writetext BillsGrandpaAskToSeeMonText
	yesorno
	iffalse .SaidNo
	...
	special BillsGrandfather
	iffalse .SaidNo
	ifnotequal RENAMON, .WrongPokemon
	scall .CorrectPokemon
	setevent EVENT_SHOWED_RENAMON_VULPIX_TO_BILLS_GRANDPA
	sjump .ShowedRenamonVulpix
