...
PokemonFanClubPalmonScript:
	opentext
	writetext PokemonFanClubPalmonText
	cry PALMON
	waitbutton
	closetext
	end
...
PokemonFanClub_MapEvents:
	...
	object_event  7,  3, SPRITE_GOBLIMON, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, PokemonFanClubPalmonScript, -1
