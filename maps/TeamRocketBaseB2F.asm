...
RocketBaseBossFScript:
	...
	applymovement TEAMROCKETBASEB2F_DRAGON, RocketBaseKimeramonAttacksMovement
...
RocketBaseKimeramonAttacksMovement:
	big_step RIGHT
	big_step RIGHT
	big_step RIGHT
	big_step RIGHT
...
TeamRocketBaseB2F_MapEvents:
	...
	object_event  9, 13, SPRITE_DRAGON, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEAM_ROCKET_BASE_B2F_KIMERAMON
