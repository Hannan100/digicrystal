...
GotsumonExplodingTrap:
	special FadeOutPalettes
	cry GOTSUMON
	special FadeInPalettes
	setlasttalked -1
	loadvar VAR_BATTLETYPE, BATTLETYPE_TRAP
	loadwildmon GOTSUMON, 21
	startbattle
	end

LadydevmonExplodingTrap:
	special FadeOutPalettes
	cry LADYDEVMON
	special FadeInPalettes
	setlasttalked -1
	loadvar VAR_BATTLETYPE, BATTLETYPE_TRAP
	loadwildmon LADYDEVMON, 21
	startbattle
	end
...
TeamRocketBaseB1F_MapEvents:
	...
	; Each Pokémon (Voltorb, Ladydevmon, Gotsumon) knows Selfdestruct.
