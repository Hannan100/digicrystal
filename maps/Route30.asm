...
YoungsterJoey_ImportantBattleScript:
	...
	applymovement ROUTE30_MONSTER2, Route30_JoeysPunimonAttacksMovement
	opentext
	faceplayer
	...
	closetext
	playsound SFX_TACKLE
	applymovement ROUTE30_MONSTER1, Route30_MikeysPunimonAttacksMovement
...
Route30_JoeysPunimonAttacksMovement:
	fix_facing
	big_step UP
	big_step DOWN
	step_end

Route30_MikeysPunimonAttacksMovement:
	fix_facing
	big_step DOWN
	big_step UP
	step_end
