	...
	const UNIONCAVEB2F_SEADRAMON

UnionCaveB2F_MapScripts:
	def_scene_scripts

	def_callbacks
	callback MAPCALLBACK_OBJECTS, .Seadramon

.Seadramon:
	checkflag ENGINE_UNION_CAVE_SEADRAMON
	iftrue .NoAppear
	readvar VAR_WEEKDAY
	ifequal FRIDAY, .Appear
.NoAppear:
	disappear UNIONCAVEB2F_SEADRAMON
	endcallback

.Appear:
	appear UNIONCAVEB2F_SEADRAMON
	endcallback

UnionCaveSeadramon:
	faceplayer
	cry SEADRAMON
	loadwildmon SEADRAMON, 20
	startbattle
	disappear UNIONCAVEB2F_SEADRAMON
	setflag ENGINE_UNION_CAVE_SEADRAMON
...
UnionCaveB2F_MapEvents:
	...
	object_event 11, 31, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, UnionCaveSeadramon, EVENT_UNION_CAVE_B2F_SEADRAMON
