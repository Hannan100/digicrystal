	...
	const CERULEANTRADESPEECHHOUSE_PAGUMON
...
CeruleanTradeSpeechHousePagumonScript:
	opentext
	writetext CeruleanTradeSpeechHousePagumonText
	cry PAGUMON
	waitbutton
	closetext
	end
...
CeruleanTradeSpeechHousePagumonText:
	text "PAGUMON: Zuba zubaa."
	done
...
CeruleanTradeSpeechHouse_MapEvents:
	...
	object_event  5,  6, SPRITE_PAGUMON, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeruleanTradeSpeechHousePagumonScript, -1
