	...
	const BLACKTHORNDRAGONSPEECHHOUSE_GAZIMON
...
BlackthornDragonSpeechHouse_MapEvents:
	...
	object_event  5,  5, SPRITE_GAZIMON, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, BlackthornDragonSpeechHouseDratiniScript, -1
