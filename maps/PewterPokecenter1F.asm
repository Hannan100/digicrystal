	...
	const PEWTERPOKECENTER1F_CANDLEMON
...
PewterPokecenter1F_MapEvents:
	...
	object_event  1,  3, SPRITE_CANDLEMON, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, PewterCandlemon, -1
