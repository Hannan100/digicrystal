...
INCBIN "gfx/footprints/botamon.1bpp"
...
>
> But a few Pokémon end up with weird items. Abra has a catch rate of 200, or $C8; and Monocromon, Horsea, Goldeen, and Staryu have a catch rate of 225, or $E1. Those indexes correspond to the items `TM_PSYCH_UP` and `TM_ICE_PUNCH`, which seem like random choices—because they are.
>
