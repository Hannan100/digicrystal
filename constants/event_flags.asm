...
; Johto story events
	...
	const EVENT_CLEARED_OTAMAMON_WELL
	const EVENT_REFUSED_TO_TAKE_EGG_FROM_ELMS_AIDE
	const EVENT_GOT_DEMIVEEMON_EGG_FROM_ELMS_AIDE
	...
	const EVENT_LAKE_OF_RAGE_EXPLAINED_WEIRD_SWIMMON
	const EVENT_LAKE_OF_RAGE_ASKED_FOR_SWIMMON
	...
	const EVENT_DEMIVEEMON_HATCHED
	const EVENT_SHOWED_DEMIVEEMON_TO_ELM
	...
	const EVENT_GOT_KURAMON_FROM_KIYO
...
; Decorations
	...
	const EVENT_DECO_GATOMON_DOLL
	const EVENT_DECO_SURFING_GATOMON_DOLL
	const EVENT_DECO_CLEFAIRY_DOLL
	const EVENT_DECO_CANDLEMON_DOLL
	const EVENT_DECO_NYOKOMON_DOLL
	const EVENT_DECO_GUILMON_DOLL
	const EVENT_DECO_GARURUMON_DOLL
	const EVENT_DECO_BETAMON_DOLL
	const EVENT_DECO_DIGLETT_DOLL
	const EVENT_DECO_STARMIE_DOLL
	const EVENT_DECO_SWIMMON_DOLL
	const EVENT_DECO_GOBLIMON_DOLL
	const EVENT_DECO_KRYSALIMON_DOLL
	const EVENT_DECO_DATAMON_DOLL
	const EVENT_DECO_NUMEMON_DOLL
	const EVENT_DECO_VOLTORB_DOLL
	const EVENT_DECO_MOTIMON_DOLL
	const EVENT_DECO_UNOWN_DOLL
	const EVENT_DECO_GOTSUMON_DOLL
	...
	const EVENT_DECO_BIG_ARMDILOMON_DOLL
	const EVENT_DECO_BIG_SEADRAMON_DOLL
; More Johto story events
	...
	const EVENT_LEARNED_OTAMAMONTAIL
	const EVENT_LEARNED_GABUMON_TAIL
	...
	const EVENT_SHOWED_GOBLIMON_TO_BILLS_GRANDPA
	const EVENT_SHOWED_STARYU_TO_BILLS_GRANDPA
	const EVENT_SHOWED_RENAMON_VULPIX_TO_BILLS_GRANDPA
...
; Johto itemballs
	...
	const EVENT_OTAMAMON_WELL_B1F_SUPER_POTION
	const EVENT_OTAMAMON_WELL_B2F_TM_RAIN_DANCE
...
; Johto people
	...
	const EVENT_MAHOGANY_MART_LANCE_AND_KIMERAMON
	...
	const EVENT_TEAM_ROCKET_BASE_B2F_KIMERAMON
	...
	const EVENT_AZALEA_TOWN_OTAMAMONS
	const EVENT_AZALEA_TOWN_OTAMAMONTAIL_ROCKET
	const EVENT_OTAMAMON_WELL_OTAMAMONS
	const EVENT_OTAMAMON_WELL_ROCKETS
	const EVENT_KURTS_HOUSE_OTAMAMON
	...
	const EVENT_OTAMAMON_WELL_KURT
	...
	const EVENT_UNION_CAVE_B2F_SEADRAMON
