...
InitializeEventsScript:
	...
	setevent EVENT_MAHOGANY_MART_LANCE_AND_KIMERAMON
	setevent EVENT_TEAM_ROCKET_BASE_B2F_GRUNT_WITH_EXECUTIVE
	setevent EVENT_TEAM_ROCKET_BASE_B2F_EXECUTIVE
	setevent EVENT_TEAM_ROCKET_BASE_B2F_KIMERAMON
	...
	setevent EVENT_AZALEA_TOWN_OTAMAMONS
	setevent EVENT_KURTS_HOUSE_OTAMAMON
