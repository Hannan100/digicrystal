...
.ornaments
	...
	db DECO_GARURUMON_DOLL ; 24
	db DECO_BETAMON_DOLL ; 25
	db DECO_DIGLETT_DOLL ; 26
	db DECO_STARMIE_DOLL ; 27
	db DECO_SWIMMON_DOLL ; 28
	db DECO_GOBLIMON_DOLL ; 29
	db DECO_KRYSALIMON_DOLL ; 2a
	db DECO_DATAMON_DOLL ; 2b
	db DECO_NUMEMON_DOLL ; 2c
	db DECO_VOLTORB_DOLL ; 2d
	db DECO_MOTIMON_DOLL ; 2e
	db DECO_UNOWN_DOLL ; 2f
	db DECO_GOTSUMON_DOLL ; 30
