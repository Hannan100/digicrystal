...
DebugRoomMenu_DecorateAll:
	...
	ld b, SET_FLAG
	ld c, EVENT_DECO_BIG_SEADRAMON_DOLL - EVENT_DECO_BED_1 + 1
.loop
	push bc
	push de
	push hl
...
DebugRoomMenu_PokemonGet_Page1Values:
	db 8
	paged_value wDebugRoomMonSpecies,       1,   NUM_POKEMON, NYOKOMON,      DebugRoom_BoxStructStrings.Pokemon,   DebugRoom_PrintPokemonName, FALSE
