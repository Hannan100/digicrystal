...
; entries correspond to SPRITE_ANIM_OAMSET_* constants
	...
	dbw $6c, .OAMData_GSIntroDatamon          ; SPRITE_ANIM_OAMSET_GS_INTRO_DATAMON_1
	dbw $6e, .OAMData_GSIntroDatamon          ; SPRITE_ANIM_OAMSET_GS_INTRO_DATAMON_2
	...
	dbw $10, .OAMData_GSIntroStarter           ; SPRITE_ANIM_OAMSET_GS_INTRO_TANEMON
	dbw $29, .OAMData_GSIntroStarter           ; SPRITE_ANIM_OAMSET_GS_INTRO_KOROMON
	dbw $42, .OAMData_GSIntroStarter           ; SPRITE_ANIM_OAMSET_GS_INTRO_BUKAMON
	...
	dbw $00, .OAMData_SlotsGolemon               ; SPRITE_ANIM_OAMSET_SLOTS_GOLEMON_1
	dbw $08, .OAMData_SlotsGolemon               ; SPRITE_ANIM_OAMSET_SLOTS_GOLEMON_2
