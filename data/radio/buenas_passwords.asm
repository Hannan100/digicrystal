...
.JohtoStarters: db BUENA_MON,    10, KOROMON, BUKAMON, TANEMON
...
.Pokemon1:      db BUENA_MON,    10, PIKACHU, TSUNOMON, GOTSUMON
.Pokemon2:      db BUENA_MON,    10, POROMON, KOKOMON, TAPIRMON
