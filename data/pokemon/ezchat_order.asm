...
.ku_gu:    db GLOOM, FANBEEMON, GLIGAR, CRABMON, GRANBULL, DEVIMON, -1
...
.no:       db KUDAMON, -1
.ha_ba_pa: db SEEL, STEELIX, TYPHLOSION, DRAGONAIR, STINGMON, HUNYBEEMON, YOKOMON, BLISSEY, MUSHROOMON, MUSHROOMONECT, QWILFISH, MR__MIME, KURAMON, CLOYSTER, TYRANITAR, -1
...
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, WASPMON, WIGGLYTUFF, PUNIMON, NYOKOMON, BOTAMON, AERODACTYL, MAGBY, IGGLYBUFF, UMBREON, ARTICUNO, CANDLEMON, ELECMON, -1
...
.ri:       db CHARMELEON, TYRANNOMON, URSARING, -1
.ru:       db JYNX, LUGIA, -1
