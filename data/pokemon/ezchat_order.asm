...
.ki_gi:    db SUNFLORA, WORMMON, GYARADOS, RAPIDASH, NINETALES, GIRAFARIG, BELLOSSOM, KINGDRA, KINGLER, -1
.ku_gu:    db GLOOM, PINECO, GLIGAR, KRABBY, GRANBULL, CROBAT, -1
.ke_ge:    db ABRA, INFERMON, TAUROS, -1
.ko_go:    db MAGIKARP, MAGNEMITE, TSUMEMON, KERAMON, MACHOKE, KAKUNA, PSYDUCK, PHANPY, PUNIMON, GOLDUCK, GOLBAT, GOLEM, GRAVELER, VENONAT, -1
...
.ra:       db RAIKOU, RAICHU, CHANSEY, TSUNOMON, LAPRAS, VILEPLUME, LANTURN, -1
