...
.a:        db GAZIMON, ARBOK, SEAKING, ARIADOS, GOMAMON, UNOWN, -1
.i:        db EEVEE, GEODUDE, KOKOMON, PILOSWINE, ONIX, -1
...
.o:        db FERALIGATR, FURRET, OCTILLERY, PRIMEAPE, NYAROMON, STANTLER, TOKOOMON, FEAROW, OMASTAR, OMANYTE, -1
...
.ku_gu:    db GLOOM, FANBEEMON, GLIGAR, KRABBY, GRANBULL, CROBAT, -1
.ke_ge:    db ABRA, GENGAR, TAUROS, -1
.ko_go:    db MAGIKARP, MAGNEMITE, TSUMEMON, HAUNTER, MACHOKE, TENTOMON, PSYDUCK, PHANPY, TSUNOMON, GOLDUCK, DEMDEVIMON, GOLEM, GRAVELER, KUNEMON, -1
...
.su_zu:    db SUICUNE, STARMIE, SCYTHER, PAGUMON, BEEDRILL, HYPNO, DROWZEE, -1
...
.to_do:    db DODUO, DODRIO, SMEARGLE, KOFFING, TENTACRUEL, VEEMON, DEMIVEEMON, GOLDEEN, WORMMON, DONPHAN, -1
...
.no:       db DUNSPARCE, -1
.ha_ba_pa: db SEEL, STEELIX, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, YOKOMON, BLISSEY, MUSHROOMON, MUSHROOMONECT, QWILFISH, MR__MIME, KURAMON, CLOYSTER, TYRANITAR, -1
.hi_bi_pi: db CLEFFA, MOTIMON, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, PICHU, CLEFAIRY, CHARMANDER, STARYU, KOROMON, SUNKERN, TEDDIURSA, VOLTORB, -1
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, FORRETRESS, WIGGLYTUFF, PUNIMON, NYOKOMON, BOTAMON, AERODACTYL, MAGBY, IGGLYBUFF, UMBREON, ARTICUNO, JIGGLYPUFF, SNUBBULL, -1
.he_be_pe: db BAYLEEF, GRIMER, MUK, HERACROSS, HOUNDOOM, PERSIAN, LICKITUNG, -1
.ho_bo_po: db HO_OH, POROMON, PIDGEY, PONYTA, SKIPLOOM, PORYGON, PORYGON2, -1
...
.ru:       db JYNX, LUGIA, -1
.re:       db MAGNETON, LEDIAN, GUMMYMON, -1
.ro:       db VULPIX, -1
