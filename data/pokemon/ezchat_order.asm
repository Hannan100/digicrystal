...
.no:       db KUDAMON, -1
.ha_ba_pa: db SEEL, STEELIX, GREYMON, DRAGONAIR, STINGMON, HUNYBEEMON, YOKOMON, BLISSEY, MUSHROOMON, MUSHROOMONECT, QWILFISH, MR__MIME, KURAMON, CLOYSTER, TYRANITAR, -1
