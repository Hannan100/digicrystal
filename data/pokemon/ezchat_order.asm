...
.i:        db EEVEE, GREYMON, SPINARAK, PILOSWINE, ONIX, -1
.u:        db ARCANINE, SUDOWOODO, RAIDRAMON, VICTREEBEL, WOOPER, SWINUB, -1
...
.ka_ga:    db GROWLITHE, EXVEEMON, DRAGONITE, PINSIR, SNORLAX, KABUTO, KABUTOPS, HITMONTOP, KOROMON, POROMON, FARFETCH_D, CUBONE, MAROWAK, KANGASKHAN, -1
.ki_gi:    db SUNFLORA, CATERPIE, GYARADOS, RAPIDASH, NINETALES, GIRAFARIG, BELLOSSOM, KINGDRA, KINGLER, -1
.ku_gu:    db GLOOM, PINECO, GLIGAR, MONOCROMON, GRANBULL, CROBAT, -1
.ke_ge:    db ABRA, GENGAR, TAUROS, -1
.ko_go:    db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, VEEDRAMON, KAKUNA, PSYDUCK, PHANPY, RATTATA, GOLDUCK, GOLBAT, GOLEM, GROWLMON, VENONAT, -1
.sa_za:    db RHYHORN, PUPITAR, CORSOLA, HITMONLEE, ZAPDOS, JOLTEON, SANDSHREW, VEEMON, -1 ; RHYDON should lead this list
.shi_ji:   db SEADRA, SHELLDER, VAPOREON, DEWGONG, -1
.su_zu:    db SUICUNE, STARMIE, SCYTHER, ZUBAT, BEEDRILL, HYPNO, DROWZEE, -1
.se_ze:    db DEMIVEEMON, CELEBI, -1
...
.ni:       db AGUMON, NIDOQUEEN, GUILMON, NIDORAN_F, NIDORINA, NIDORINO, MEOWTH, SNEASEL, POLIWHIRL, POLITOED, HUNYBEEMON, POLIWAG, -1
.nu:       db QUAGSIRE, -1
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
...
.fu_bu_pu: db MOLTRES, FLAREON, TYRANNOMON, MAGMAR, FORRETRESS, WIGGLYTUFF, IVYSAUR, BULBASAUR, BOTAMON, AERODACTYL, MAGBY, IGGLYBUFF, UMBREON, ARTICUNO, JIGGLYPUFF, SNUBBULL, -1
.he_be_pe: db BAYLEEF, GRIMER, MUK, HERACROSS, HOUNDOOM, PERSIAN, LICKITUNG, -1
.ho_bo_po: db HO_OH, HOOTHOOT, NYAROMON, PONYTA, SKIPLOOM, PORYGON, PORYGON2, -1
.ma:       db MAGCARGO, SLUGMA, QUILAVA, FLAMEDRMON, WEEZING, MARILL, AZUMARILL, ELECTRODE, MANKEY, MANTINE, -1
