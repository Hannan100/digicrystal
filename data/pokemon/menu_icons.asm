...
MonMenuIcons:
	...
	db ICON_BULBASAUR   ; BOTAMON
	db ICON_CHARMANDER  ; CHARMANDER
	db ICON_CHARMANDER  ; CHARMELEON
	db ICON_BIGMON      ; CHARIZARD
	db ICON_DEMIVEEMON    ; DEMIVEEMON
	db ICON_DEMIVEEMON    ; KOROMON
	db ICON_DEMIVEEMON    ; POROMON
	...
	db ICON_POLIWAG     ; HUNYBEEMON
	db ICON_HUMANSHAPE  ; ABRA
	db ICON_HUMANSHAPE  ; KADABRA
	db ICON_HUMANSHAPE  ; TYRANNOMON
	db ICON_FIGHTER     ; MACHOP
	db ICON_FIGHTER     ; VEEDRAMON
	db ICON_FIGHTER     ; EXVEEMON
	db ICON_ODDISH      ; FLAMEDRMON
	db ICON_ODDISH      ; RAIDRAMON
	db ICON_ODDISH      ; VICTREEBEL
	db ICON_JELLYFISH   ; TENTACOOL
	db ICON_JELLYFISH   ; TENTACRUEL
	db ICON_GREYMON     ; GREYMON
	db ICON_GREYMON     ; GROWLMON
	db ICON_GREYMON     ; GOLEM
