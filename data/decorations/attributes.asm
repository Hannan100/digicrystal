...
; entries correspond to deco constants
	...
	decoration DECO_POSTER,  CANDLEMON,      SET_UP_POSTER,     EVENT_DECO_POSTER_4,                $25
	...
	decoration DECO_DOLL,    CANDLEMON,      SET_UP_DOLL,       EVENT_DECO_CANDLEMON_DOLL,         SPRITE_CANDLEMON
	decoration DECO_DOLL,    NYOKOMON,       SET_UP_DOLL,       EVENT_DECO_NYOKOMON_DOLL,          SPRITE_NYOKOMON
	decoration DECO_DOLL,    GUILMON,      SET_UP_DOLL,       EVENT_DECO_GUILMON_DOLL,         SPRITE_GUILMON
