...
; entries correspond to deco constants
	...
	decoration DECO_DOLL,    DEMIVEEMON,        SET_UP_DOLL,       EVENT_DECO_DEMIVEEMON_DOLL,           SPRITE_DEMIVEEMON
	...
	decoration DECO_DOLL,    GREYMON,         SET_UP_DOLL,       EVENT_DECO_GREYMON_DOLL,            SPRITE_GREYMON
