...
; entries correspond to deco constants
	...
	decoration DECO_BED,     GATOMON_BED,     SET_UP_BED,        EVENT_DECO_BED_4,                   $1e
	...
	decoration DECO_POSTER,  GATOMON,         SET_UP_POSTER,     EVENT_DECO_POSTER_2,                $23
	...
	decoration DECO_BIGDOLL, ARMDILOMON,            SET_UP_BIG_DOLL,   EVENT_DECO_BIG_ARMDILOMON_DOLL,           SPRITE_BIG_ARMDILOMON
	decoration DECO_BIGDOLL, SEADRAMON,          SET_UP_BIG_DOLL,   EVENT_DECO_BIG_SEADRAMON_DOLL,         SPRITE_BIG_SEADRAMON
	decoration DECO_PLANT,   PUT_IT_AWAY,     PUT_AWAY_DOLL,     EVENT_TEMPORARY_UNTIL_MAP_RELOAD_1, 0
	decoration DECO_DOLL,    GATOMON,         SET_UP_DOLL,       EVENT_DECO_GATOMON_DOLL,            SPRITE_GATOMON
	decoration DECO_PLANT,   SURF_PIKA_DOLL,  SET_UP_DOLL,       EVENT_DECO_SURFING_GATOMON_DOLL,    SPRITE_SURFING_GATOMON
	...
	decoration DECO_DOLL,    GARURUMON,        SET_UP_DOLL,       EVENT_DECO_GARURUMON_DOLL,           SPRITE_GARURUMON
	...
	decoration DECO_DOLL,    DATAMON,        SET_UP_DOLL,       EVENT_DECO_DATAMON_DOLL,           SPRITE_DATAMON
	...
	decoration DECO_DOLL,    GOTSUMON,         SET_UP_DOLL,       EVENT_DECO_GOTSUMON_DOLL,            SPRITE_GOTSUMON
