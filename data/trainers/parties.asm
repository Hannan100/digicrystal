...
MortyGroup:
	...
	db 21, KERAMON,    HYPNOSIS, MIMIC, CURSE, NIGHT_SHADE
	db 25, KRYSALIMON,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
...
PsychicGroup:
	...
	db 17, TAPIRMON,    HYPNOSIS, DISABLE, DREAM_EATER, NO_MOVE
	db -1 ; end
...
MysticalmanGroup:
	...
	db 23, TAPIRMON,    DREAM_EATER, HYPNOSIS, DISABLE, CONFUSION
	db 23, KERAMON,    LICK, HYPNOSIS, MEAN_LOOK, CURSE
