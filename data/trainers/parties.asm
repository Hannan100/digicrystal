...
FalknerGroup:
	...
	db  7, MKABUTIMON,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db  9, ANGEMON,  TACKLE, MUD_SLAP, GUST, NO_MOVE
	db -1 ; end
...
BugsyGroup:
	...
	db 14, WORMMON,    TACKLE, STRING_SHOT, HARDEN, NO_MOVE
	db 14, TENTOMON,     POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
	db 16, KUWAGAMON,    QUICK_ATTACK, LEER, FURY_CUTTER, NO_MOVE
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 21, TSUMEMON,     LICK, SPITE, MEAN_LOOK, CURSE
	db 21, KERAMON,    BOARMONSIS, MIMIC, CURSE, NIGHT_SHADE
	db 25, KRYSALIMON,     BOARMONSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 23, KERAMON,    SPITE, MEAN_LOOK, MIMIC, NIGHT_SHADE
	db -1 ; end
...
JasmineGroup:
	...
	db 30, HAGURUMON,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 30, HAGURUMON,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 35, ANKYLOMON,    SCREECH, SUNNY_DAY, ROCK_THROW, IRON_TAIL
	db -1 ; end
...
ChuckGroup:
	...
	db 30, POLIWRATH,  BOARMONSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end
...
Rival1Group:
	...
	db 20, KERAMON,    LICK, SPITE, MEAN_LOOK, CURSE
	db 18, HAGURUMON,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, PAGUMON,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, PALMON,    GROWL, REFLECT, RAZOR_LEAF, POISONPOWDER
	db -1 ; end
	...
	db 18, HAGURUMON,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, PAGUMON,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, AGUMON,    LEER, SMOKESCREEN, EMBER, QUICK_ATTACK
	db -1 ; end
	...
	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 30, DEMDEVIMON,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 28, HAGURUMON,  TACKLE, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	db 30, KERAMON,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, TOGEMON,   REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 30, KERAMON,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, AGUMON,    SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 30, KERAMON,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, IKKAKUMON, RAGE, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end

	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 34, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 36, DEMDEVIMON,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 35, GUARDROMON,   THUNDERSHOCK, SONICBOOM, THUNDER_WAVE, SWIFT
	db 35, KERAMON,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADWIZARDMON,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, TOGEMON,   REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 35, KERAMON,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADWIZARDMON,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, GREYMON, SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 34, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 36, DEMDEVIMON,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 34, GUARDROMON,   THUNDERSHOCK, SONICBOOM, THUNDER_WAVE, SWIFT
	db 35, KERAMON,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADWIZARDMON,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, IKKAKUMON, RAGE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
WillGroup:
	...
	db 40, EXVEEMON,       QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db 41, JYNX,       DOUBLESLAP, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
	db 41, DIGMON,  REFLECT, LEECH_SEED, EGG_BOMB, PSYCHIC_M
	db 41, GEKOMON,    CURSE, AMNESIA, BODY_SLAM, PSYCHIC_M
	db 42, EXVEEMON,       QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	db 43, ARMDILOMON,       BIND, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	db 46, CYBERDRMON,    ROCK_SLIDE, FORESIGHT, VITAL_THROW, CROSS_CHOP
	db -1 ; end
...
KarenGroup:
	...
	db 45, KRYSALIMON,     LICK, SPITE, CURSE, DESTINY_BOND
...
KogaGroup:
	...
	db 40, LOPMON,    DOUBLE_TEAM, SPIDER_WEB, BATON_PASS, GIGA_DRAIN
	db 41, VENOMOTH,   SUPERSONIC, GUST, PSYCHIC_M, TOXIC
	db 43, WASPMON, PROTECT, SWIFT, EXPLOSION, SPIKES
	db 42, RAREMON,        MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	db 44, DEVIMON,     DOUBLE_TEAM, QUICK_ATTACK, WING_ATTACK, TOXIC
	db -1 ; end
...
ChampionGroup:
	...
	db 47, KIMERAMON,  THUNDER_WAVE, TWISTER, THUNDER, HYPER_BEAM
	db 47, KIMERAMON,  THUNDER_WAVE, TWISTER, BLIZZARD, HYPER_BEAM
	db 46, AERODACTYL, WING_ATTACK, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
	db 46, TYRANNOMON,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
	db 50, KIMERAMON,  FIRE_BLAST, SAFEGUARD, OUTRAGE, HYPER_BEAM
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_MOVES
	db 41, MONOCROMON,   DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 41, RHYHORN,    FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HORN_DRILL
	db 42, OMASTAR,    BITE, SURF, PROTECT, SPIKE_CANNON
	db 44, ARMDILOMON,       BIND, ROCK_SLIDE, BIDE, SANDSTORM
...
MistyGroup:
	...
	db 44, SEADRAMON,     SURF, PERISH_SONG, BLIZZARD, RAIN_DANCE
...
LtSurgeGroup:
	...
	db 40, GUARDROMON,   LOCK_ON, DOUBLE_TEAM, SWIFT, ZAP_CANNON
	db 40, ELECTRODE,  SCREECH, DOUBLE_TEAM, SWIFT, EXPLOSION
...
ScientistGroup:
	...
	db 30, PORYMON,    CONVERSION, CONVERSION2, RECOVER, TRI_ATTACK
	db -1 ; end

ErikaGroup:
	; ERIKA (1)
	db "ERIKA@", TRAINERTYPE_MOVES
	db 42, SHURIMON,    VINE_WHIP, BIND, GIGA_DRAIN, SLEEP_POWDER
	db 41, BIRDRAMON,   MEGA_DRAIN, LEECH_SEED, COTTON_SPORE, GIGA_DRAIN
	db 46, VICTREEBEL, SUNNY_DAY, SYNTHESIS, ACID, RAZOR_LEAF
	db 46, DINOBEEMON,  SUNNY_DAY, SYNTHESIS, PETAL_DANCE, SOLARBEAM
	db -1 ; end
...
YoungsterGroup:
	...
	db 21, GABUMON,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, GABUMON,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, GABUMON,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
SchoolboyGroup:
	...
	db 35, RENAMON,  SUNNY_DAY, LEER, TAKE_DOWN, FLAME_WHEEL
	...
	db 35, EXVEEMON,       PECK, NIGHT_SHADE, SWIFT, FUTURE_SIGHT
	db 32, SHURIMON,    POISONPOWDER, VINE_WHIP, BIND, MEGA_DRAIN
	...
	db 38, GUARDROMON,   ZAP_CANNON, THUNDER_WAVE, LOCK_ON, SWIFT
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 38, PEGASUSMON,    TOXIC, QUICK_ATTACK, WHIRLWIND, FLY
	db 38, PEGASUSMON,    SWIFT, DETECT, STEEL_WING, FLY
	db -1 ; end

LassGroup:
	; LASS (1)
	db "CARRIE@", TRAINERTYPE_MOVES
	db 18, ELECMON,   SCARY_FACE, CHARM, BITE, LICK
	db -1 ; end
	...
	db 18, RAIDRAMON,    TACKLE, GROWL, THUNDERSHOCK, THUNDER_WAVE
	...
	; LASS (14)
	db "DANA@", TRAINERTYPE_MOVES
	db 21, RAIDRAMON,    TACKLE, GROWL, THUNDERSHOCK, THUNDER_WAVE
	...
	db 29, PAILDRAMON,   TACKLE, THUNDERSHOCK, THUNDER_WAVE, COTTON_SPORE
	db -1 ; end

	; LASS (16)
	db "DANA@", TRAINERTYPE_MOVES
	db 32, PSYDUCK,    SCRATCH, DISABLE, CONFUSION, SCREECH
	db 32, PAILDRAMON,   TACKLE, THUNDERPUNCH, THUNDER_WAVE, COTTON_SPORE
	db -1 ; end

	; LASS (17)
	db "DANA@", TRAINERTYPE_MOVES
	db 36, PAILDRAMON,   SWIFT, THUNDERPUNCH, THUNDER_WAVE, COTTON_SPORE
...
JanineGroup:
	...
	db 36, DEVIMON,     SCREECH, SUPERSONIC, CONFUSE_RAY, WING_ATTACK
	db 36, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 36, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 33, LOPMON,    SCARY_FACE, GIGA_DRAIN, STRING_SHOT, NIGHT_SHADE
...
CooltrainerMGroup:
	...
	db 26, GUILMON, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db 26, GARURUMON,   WITHDRAW, WATER_GUN, BITE, CURSE
	db 26, NYOKOMON,  LEECH_SEED, POISONPOWDER, SLEEP_POWDER, RAZOR_LEAF
	db -1 ; end
	...
	db 35, COELAMON,    BUBBLEBEAM, STOMP, GUILLOTINE, PROTECT
	...
	db 39, COELAMON,    KINGS_ROCK,   SURF, STOMP, GUILLOTINE, BLIZZARD
	db 39, FLAREON,    NO_ITEM,      FLAMETHROWER, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end

	; COOLTRAINERM (8)
	db "RYAN@", TRAINERTYPE_MOVES
	db 25, PEGASUSMON,    SAND_ATTACK, QUICK_ATTACK, WHIRLWIND, WING_ATTACK
	db 27, ELECTABUZZ, THUNDERPUNCH, LIGHT_SCREEN, SWIFT, SCREECH
	db -1 ; end

	; COOLTRAINERM (9)
	db "JAKE@", TRAINERTYPE_MOVES
	db 33, MUSHROOMONECT,   LEECH_LIFE, SPORE, SLASH, SWORDS_DANCE
	...
	db 32, COELAMON,    BUBBLEBEAM, STOMP, GUILLOTINE, PROTECT
	db 32, FLAREON,    SAND_ATTACK, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end

	; COOLTRAINERM (11)
	db "BLAKE@", TRAINERTYPE_MOVES
	db 33, GUARDROMON,   THUNDERBOLT, SUPERSONIC, SWIFT, SCREECH
	db 31, QUAGSIRE,   WATER_GUN, SLAM, AMNESIA, EARTHQUAKE
	db 31, CHUUMON,  LEECH_SEED, CONFUSION, SLEEP_POWDER, SOLARBEAM
	db -1 ; end
	...
	db 27, GROWLMON, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 25, BIYOMON,   SYNTHESIS, POISONPOWDER, MEGA_DRAIN, LEECH_SEED
	...
	db 36, GATOMON,    QUICK_ATTACK, DOUBLE_TEAM, THUNDERBOLT, THUNDER
	db 32, SHELLMON,  BITE, CURSE, SURF, RAIN_DANCE
	db -1 ; end
	...
	db 32, NYOKOMON,  GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 32, PUNIMON,    GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 32, BOTAMON,   BODY_SLAM, SLEEP_POWDER, RAZOR_LEAF, SWEET_SCENT
	db -1 ; end
	...
	db 25, STINGMON, CONFUSION, SLEEP_POWDER, WHIRLWIND, GUST
	db 25, DINOBEEMON,  ABSORB, STUN_SPORE, ACID, SOLARBEAM
	db -1 ; end
...
BeautyGroup:
	...
	db 17, YOKOMON,     SYNTHESIS, TAIL_WHIP, TACKLE, POISONPOWDER
	db 17, BIYOMON,   SYNTHESIS, TAIL_WHIP, TACKLE, STUN_SPORE
	db -1 ; end
...
PokemaniacGroup:
	...
	db 36, PORYMON,    RECOVER, PSYCHIC_M, CONVERSION2, TRI_ATTACK
	db -1 ; end
...
BugCatcherGroup:
	...
	db 24, STINGMON, CONFUSION, POISONPOWDER, SUPERSONIC, WHIRLWIND
	db 24, STINGMON, CONFUSION, STUN_SPORE, SUPERSONIC, WHIRLWIND
	db 25, KABUTRIMON,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, RAGE
	db 24, STINGMON, CONFUSION, SLEEP_POWDER, SUPERSONIC, WHIRLWIND
	db -1 ; end

	; BUG_CATCHER (16)
	db "WADE@", TRAINERTYPE_MOVES
	db 30, STINGMON, CONFUSION, POISONPOWDER, SUPERSONIC, GUST
	db 30, STINGMON, CONFUSION, STUN_SPORE, SUPERSONIC, GUST
	db 32, KABUTRIMON,   FURY_ATTACK, PURSUIT, TWINEEDLE, DOUBLE_TEAM
	db 34, STINGMON, PSYBEAM, SLEEP_POWDER, GUST, WHIRLWIND
	db -1 ; end
...
FisherGroup:
	...
	db 35, SUBMARIMON,   TOXIC, MINIMIZE, SURF, PIN_MISSILE
	...
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_ATTACK
	db 37, SUBMARIMON,   ROLLOUT, SURF, PIN_MISSILE, TAKE_DOWN
	db -1 ; end
...
SailorGroup:
	...
	db 18, CRABMON,     BUBBLE, LEER, VICEGRIP, HARDEN
	db 20, CRABMON,     BUBBLEBEAM, LEER, VICEGRIP, HARDEN
	db -1 ; end
	...
	db 38, AERVDRAMON,   WHIRLPOOL, RAIN_DANCE, BODY_SLAM, PERISH_SONG
...
SuperNerdGroup:
	...
	db 19, OTAMAMON,   CURSE, WATER_GUN, GROWL, STRENGTH
	db -1 ; end
...
Rival2Group:
	...
	db 42, DEMDEVIMON,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 41, GUARDROMON,   THUNDERSHOCK, SONICBOOM, THUNDER_WAVE, SWIFT
	db 43, KRYSALIMON,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, TOGEMON,   RAZOR_LEAF, POISONPOWDER, BODY_SLAM, LIGHT_SCREEN
	db -1 ; end
	...
	db 43, KRYSALIMON,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, GREYMON, SMOKESCREEN, QUICK_ATTACK, FLAME_WHEEL, SWIFT
	db -1 ; end
	...
	db 43, KRYSALIMON,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, IKKAKUMON, RAGE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end

	; RIVAL2 (4)
	db "?@", TRAINERTYPE_MOVES
	db 45, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 48, DEVIMON,     TOXIC, BITE, CONFUSE_RAY, WING_ATTACK
	db 45, GUARDROMON,   THUNDER, SONICBOOM, THUNDER_WAVE, SWIFT
	db 46, KRYSALIMON,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, TOGEMON,   GIGA_DRAIN, BODY_SLAM, LIGHT_SCREEN, SAFEGUARD
	db -1 ; end
	...
	db 46, KRYSALIMON,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, GREYMON, SMOKESCREEN, QUICK_ATTACK, FIRE_BLAST, SWIFT
	db -1 ; end
	...
	db 46, KRYSALIMON,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, IKKAKUMON, SURF, RAIN_DANCE, SLASH, SCREECH
	db -1 ; end
...
HikerGroup:
	...
	db 38, ANKYLOMON,    DIG, IRON_TAIL, SANDSTORM, SLAM
	db -1 ; end
	...
	db 34, MONOCROMON,   MAGNITUDE, SELFDESTRUCT, DEFENSE_CURL, ROLLOUT
	db 36, GOLEMON,      MAGNITUDE, SELFDESTRUCT, DEFENSE_CURL, ROLLOUT
	db 34, STRIKDRMON,    KARATE_CHOP, VITAL_THROW, HEADBUTT, DIG
	db -1 ; end
...
BurglarGroup:
	...
	db 26, RENAMON,  ROAR, EMBER, LEER, TAKE_DOWN
	db 24, LADYDEVMON,    TACKLE, SMOG, SLUDGE, SMOKESCREEN
	db -1 ; end
...
BlackbeltGroup:
	...
	db 33, ARMDILOMON,       BIND, ROCK_THROW, TOXIC, DIG
	db 38, CYBERDRMON,    HEADBUTT, SWAGGER, THUNDERPUNCH, VITAL_THROW
	db 33, ANKYLOMON,    EARTHQUAKE, ROCK_THROW, IRON_TAIL, SANDSTORM
	...
	db 25, STRIKDRMON,    LEER, KARATE_CHOP, SEISMIC_TOSS, ROCK_SLIDE
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 33, LADYDEVMON,    TACKLE, SLUDGE, SMOKESCREEN, HAZE
	...
	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 30, LADYDEVMON,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 30, LADYDEVMON,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 30, LADYDEVMON,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 32, WEEZING,    TACKLE, EXPLOSION, SLUDGE, SMOKESCREEN
	db 30, LADYDEVMON,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 30, LADYDEVMON,    TACKLE, SMOG, SLUDGE, SMOKESCREEN
	db -1 ; end
...
PsychicGroup:
	...
	db 17, TAPIRMON,    BOARMONSIS, DISABLE, DREAM_EATER, NO_MOVE
	db -1 ; end

	; PSYCHIC_T (6)
	db "NORMAN@", TRAINERTYPE_MOVES
	db 17, OTAMAMON,   TACKLE, GROWL, WATER_GUN, NO_MOVE
	db 20, OTAMAMON,   CURSE, BODY_SLAM, WATER_GUN, CONFUSION
	db -1 ; end

	; PSYCHIC_T (7)
	db "MARK@", TRAINERTYPE_MOVES
	db 13, WIZARDMON,       TELEPORT, FLASH, NO_MOVE, NO_MOVE
	db 13, WIZARDMON,       TELEPORT, FLASH, NO_MOVE, NO_MOVE
	db 15, KADWIZARDMON,    TELEPORT, KINESIS, CONFUSION, NO_MOVE
	db -1 ; end

	; PSYCHIC_T (8)
	db "PHIL@", TRAINERTYPE_MOVES
	db 24, VEEDRAMON,       LEER, NIGHT_SHADE, FUTURE_SIGHT, CONFUSE_RAY
	db 26, KADWIZARDMON,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db -1 ; end
...
PicnickerGroup:
	...
	db 16, GATOMON,    THUNDERSHOCK, GROWL, QUICK_ATTACK, DOUBLE_TEAM
	db -1 ; end
	...
	db 30, WOODMON, SLEEP_POWDER, POISONPOWDER, STUN_SPORE, SLUDGE_BOMB
	...
	db 33, BIRDRAMON,   STUN_SPORE, SUNNY_DAY, LEECH_SEED, COTTON_SPORE
	db 33, BIRDRAMON,   SUNNY_DAY, SLEEP_POWDER, LEECH_SEED, COTTON_SPORE
	db 38, BOTAMON,   SOLARBEAM, RAZOR_LEAF, HEADBUTT, MUD_SLAP
	db -1 ; end
...
CamperGroup:
	...
	db 33, MONOCROMON,   SELFDESTRUCT, ROCK_THROW, HARDEN, MAGNITUDE
	db 33, MONOCROMON,   SELFDESTRUCT, ROCK_THROW, HARDEN, MAGNITUDE
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 32, ETEMON,      WRAP, POISON_STING, BITE, GLARE
	...
	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 23, ETEMON,      WRAP, LEER, POISON_STING, BITE
...
PokefanMGroup:
	...
	db 29, NYOKOMON,  BERRY
	db 29, GUILMON, BERRY
	db 29, GARURUMON,   BERRY
	db -1 ; end
...
TwinsGroup:
	...
	db 16, CANDLEMON, SING, DEFENSE_CURL, POUND, DISABLE
	db -1 ; end
...
RedGroup:
	...
	db 81, GATOMON,    CHARM, QUICK_ATTACK, THUNDERBOLT, THUNDER
	db 73, ESPEON,     MUD_SLAP, REFLECT, SWIFT, PSYCHIC_M
	db 75, SNORLAX,    AMNESIA, SNORE, REST, BODY_SLAM
	db 77, BOTAMON,   SUNNY_DAY, GIGA_DRAIN, SYNTHESIS, SOLARBEAM
	db 77, TYRANNOMON,  FLAMETHROWER, WING_ATTACK, SLASH, FIRE_SPIN
	db 77, SHELLMON,  RAIN_DANCE, SURF, BLIZZARD, WHIRLPOOL
	db -1 ; end

BlueGroup:
	; BLUE (1)
	db "BLUE@", TRAINERTYPE_MOVES
	db 56, PEGASUSMON,    QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	...
	db 58, DIGMON,  SUNNY_DAY, LEECH_SEED, EGG_BOMB, SOLARBEAM
	db 58, KYUBIMON,   ROAR, SWIFT, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
...
MysticalmanGroup:
	...
	db 23, TAPIRMON,    DREAM_EATER, BOARMONSIS, DISABLE, CONFUSION
	db 23, KERAMON,    LICK, BOARMONSIS, MEAN_LOOK, CURSE
