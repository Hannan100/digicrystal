...
MortyGroup:
	...
	db 25, INFERMON,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
...
KarenGroup:
	...
	db 45, INFERMON,     LICK, SPITE, CURSE, DESTINY_BOND
...
YoungsterGroup:
	...
	db 21, TSUNOMON,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, TSUNOMON,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, TSUNOMON,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
Rival2Group:
	...
	db 43, INFERMON,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	...
	db 46, INFERMON,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
