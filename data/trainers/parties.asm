...
FalknerGroup:
	...
	db  7, NYAROMON,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
...
ChuckGroup:
	...
	db 30, HUNYBEEMON,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end
...
BrunoGroup:
	...
	db 46, EXVEEMON,    ROCK_SLIDE, FORESIGHT, VITAL_THROW, CROSS_CHOP
	db -1 ; end
...
BrockGroup:
	...
	db 41, GROWLMON,   DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
...
CooltrainerMGroup:
	...
	db 26, DEMIVEEMON,   WITHDRAW, WATER_GUN, BITE, CURSE
	...
	db 35, VEEMON,  SAND_ATTACK, POISON_STING, SLASH, SWIFT
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 32, POROMON,  BITE, CURSE, SURF, RAIN_DANCE
	db -1 ; end
	...
	db 40, HAWKMON,  PINK_BOW,     EARTHQUAKE, DOUBLE_KICK, TOXIC, BODY_SLAM
...
SabrinaGroup:
	...
	db 48, TYRANNOMON,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db -1 ; end
...
SailorGroup:
	...
	db 18, MONOCROMON,     BUBBLE, LEER, VICEGRIP, HARDEN
	db 20, MONOCROMON,     BUBBLEBEAM, LEER, VICEGRIP, HARDEN
	db -1 ; end
	...
	db 38, HUNYBEEMON,  SURF, STRENGTH, ICE_PUNCH, SUBMISSION
	db -1 ; end
...
Rival2Group:
	...
	db 43, TYRANNOMON,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	...
	db 46, TYRANNOMON,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
...
HikerGroup:
	...
	db 34, GROWLMON,   MAGNITUDE, SELFDESTRUCT, DEFENSE_CURL, ROLLOUT
	db 36, GOLEM,      MAGNITUDE, SELFDESTRUCT, DEFENSE_CURL, ROLLOUT
	db 34, VEEDRAMON,    KARATE_CHOP, VITAL_THROW, HEADBUTT, DIG
	db -1 ; end
...
BlackbeltGroup:
	...
	db 38, EXVEEMON,    HEADBUTT, SWAGGER, THUNDERPUNCH, VITAL_THROW
	...
	db 25, VEEDRAMON,    LEER, KARATE_CHOP, SEISMIC_TOSS, ROCK_SLIDE
	db -1 ; end
...
PicnickerGroup:
	...
	db 30, RAIDRAMON, SLEEP_POWDER, POISONPOWDER, STUN_SPORE, SLUDGE_BOMB
	db 32, AGUMON,   EARTHQUAKE, DOUBLE_KICK, POISON_STING, IRON_TAIL
	db 32, HAWKMON,  EARTHQUAKE, DOUBLE_KICK, TAIL_WHIP, BODY_SLAM
	db -1 ; end
...
CamperGroup:
	...
	db 33, GROWLMON,   SELFDESTRUCT, ROCK_THROW, HARDEN, MAGNITUDE
	db 33, GROWLMON,   SELFDESTRUCT, ROCK_THROW, HARDEN, MAGNITUDE
...
RedGroup:
	...
	db 77, POROMON,  RAIN_DANCE, SURF, BLIZZARD, WHIRLPOOL
	db -1 ; end
...
BlueGroup:
	...
	db 54, TYRANNOMON,   DISABLE, RECOVER, PSYCHIC_M, REFLECT
